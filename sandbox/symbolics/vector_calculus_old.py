...
class ScalarField:
    ...
    def hessian(self) -> Matrix:
        """
        Compute Hessian matrix: H[i,j] = ∂ᵢ∂ⱼf
...
class VectorField:
    """
    Represents a vector field F: R^m → R^n.
