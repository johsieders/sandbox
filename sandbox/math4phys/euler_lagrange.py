...
from sympy import (
    diff, dsolve, Eq, symbols, Function, Matrix, Symbol, Expr, solve
)
...
def check_euler_lagrange(solution: Matrix, eq: Eq, x: List[Symbol], bcs: Dict[Union[float, Expr], Matrix]) -> List[bool]:
    """
