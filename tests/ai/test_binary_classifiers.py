...
def test_reg21() -> None:
    """Test regression with a Sequential model (Linear + Sigmoid)"""
    ...
    assert Y_p.shape == (4, 1)
    assert loss is not None


def test_clf21() -> None:
    """Test binary classification with BCEWithLogitsLoss"""
    F = nn.Linear(2, 1)
...
def test_clf22() -> None:
    """Test multi-class classification with CrossEntropyLoss"""
    F = nn.Linear(2, 2)
