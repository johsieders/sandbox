...
from sympy import symbols, Matrix, pprint, sin, cos, sqrt, pi
...
def run_euler_lagrange(lagrangian, x, v, bcs):
    """
    Test Euler-Lagrange solver for a free particle in 3D.
...
def test_euler_lagrange():
    """
    Test Euler-Lagrange solver for several lagrangians
    """
    n_dim = 3
